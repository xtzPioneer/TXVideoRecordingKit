...
@implementation TXCameraButton

#pragma mark - 工厂方法
+ (instancetype)defaultCameraButton{
    // 设置camera view
    TXCameraButton *cameraButton = [[TXCameraButton alloc] initWithFrame:CGRectMake(0, 0, CAMERABUTTONWIDTH, CAMERABUTTONWIDTH)];
